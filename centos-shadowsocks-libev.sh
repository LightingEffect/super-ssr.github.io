...
libtool_url="https://super-ssr.github.io/libtool-2.4.6.tar.gz"

shadowsocks_libev_config="/etc/shadowsocks-libev/config.json"
shadowsocks_libev_service="/etc/systemd/system/shadowsocks-libev.service"

libsodium_file="libsodium-1.0.18-stable"
libsodium_url="https://super-ssr.github.io/libsodium-1.0.18-stable.tar.gz"

mbedtls_file="mbedtls-2.16.3"
mbedtls_url="https://super-ssr.github.io/mbedtls-2.16.3-gpl.tgz"

localconf_file="local"
localconf_url="https://super-ssr.github.io/local.conf"
...
generate_password(){
	...
	do
		index=$[RANDOM%num]
		radompassword=$radompassword${key:$index:1}
	done
}
